...
from ..common.models.element_models import Foundation, Mast, Track, CurvedTrack, Joch, Cantilever
from ..common.enums.process_enums import ElementType, ProcessEnum
from ..services.calculation_service import CalculationService, CalculationElement
...
class TestCalculationService(unittest.TestCase):
    ...
    def test_get_element(self):
        ...
        self.assertEqual(
            calc_element.calculation_data["bottom_pressure"], (1.5 * 1.0 * 2.0 * 2500) / (1.5 * 2.0)
        )
    ...
    def test_calculate_structure_load(self):
        ...
        self.assertAlmostEqual(
            mast_load["load_case"]["total_weight"], expected_mast_weight + cantilever_weight
        )
