...
from ..common.models.element_models import Foundation, Mast, Track
...
class TestJsonElementRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.foundation1.east = 100.0
        self.foundation1.north = 200.0
        self.foundation1.altitude = 300.0
        self.foundation1.foundation_type = "Typ A"
        self.foundation1.width = 1.5
        self.foundation1.height = 1.0
        self.foundation1.depth = 2.0
        self.foundation1.set_param(ProcessEnum.MATERIAL, "Beton")

        self.foundation2 = Foundation(name="Foundation2")
        self.foundation2.east = 110.0
        self.foundation2.north = 210.0
        self.foundation2.altitude = 310.0
        self.foundation2.foundation_type = "Typ B"
        self.foundation2.width = 2.0
        self.foundation2.height = 1.2
        self.foundation2.depth = 2.5
        ...
        self.track.x_end = 150.0
        self.track.y_end = 250.0
    ...
    def test_save_and_get_by_id(self):
        ...
        self.assertEqual(element.get_param(ProcessEnum.FOUNDATION_WIDTH), 1.5)
        self.assertEqual(element.get_param(ProcessEnum.FOUNDATION_HEIGHT), 1.0)
        self.assertEqual(element.get_param(ProcessEnum.FOUNDATION_DEPTH), 2.0)
    ...
    def test_save_all_and_get_all(self):
        ...
        self.assertEqual(mast_element.get_param(ProcessEnum.MAST_HEIGHT), 15.0)
