...
class TestProcessEnum(unittest.TestCase):
    ...
    def test_process_enum_values(self):
        ...
        self.assertEqual(ProcessEnum.FOUNDATION_WIDTH.value, "foundation_width")
        self.assertEqual(ProcessEnum.FOUNDATION_DEPTH.value, "foundation_depth")
        self.assertEqual(ProcessEnum.FOUNDATION_HEIGHT.value, "foundation_height")
        
        # Allgemeine Parameter
        self.assertEqual(ProcessEnum.MATERIAL.value, "material")
