...
class ClientPlugin(PluginInterface):
    ...
    def _convert_foundation_project1(self, data: List[Dict[str, Any]], project_id: str) -> List[InfrastructureElement]:
        """Konvertiert Fundament-Daten aus Projekt 1."""
        # Implementierung hier...
        return []
        
    def _convert_mast_project1(self, data: List[Dict[str, Any]], project_id: str) -> List[InfrastructureElement]:
